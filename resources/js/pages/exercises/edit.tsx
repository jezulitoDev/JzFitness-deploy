    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-lg p-4">
                <h1 className="mb-6 text-2xl font-semibold">Editar ejercicio</h1>
                <Form
                    {...ExerciseController.update.form.put(exercise.id)}
                    className="space-y-4"
                >
                    {({ processing, errors }) => (
                        <>
                            <div className="grid gap-2">
                                ...
                                <Select
                                    ...
                                    defaultValue={String(exercise.muscle_group_id)}
                                >
                                    <SelectTrigger>
                                        <SelectValue />
                                    </SelectTrigger>
